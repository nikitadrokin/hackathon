...
type NativeDuplexConstructor = new (...args: Array<any>) => NativeDuplexInstance
...
const NativeReadable = nativeStreamModule?.Readable as NativeReadableType | undefined
const NativePassThrough =
	nativeStreamModule?.PassThrough as NativePassThroughConstructor | undefined
const NativeDuplex =
	nativeStreamModule?.Duplex as NativeDuplexConstructor | undefined
